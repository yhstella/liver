...
SLUG_TO_URL = {
    ...
    'masld-대사이상masld-masld': '/대사이상지방간-MASLD/',
    'masld-masld염-mash': '/지방간염-MASH/',
    # Autoimmune
    'autoimmune-aih-치료': '/자가면역간염-치료/',
    'autoimmune-aih-약중단': '/자가면역간염-약중단/',
    'autoimmune-aih-스테로이드-부작용': '/자가면역간염-스테로이드-부작용/',
    'autoimmune-aih-pbc-overlap': '/자가면역간염-PBC-overlap/',
    # Diagnostics — LFT / 간수치
    'diagnostics-lft-종류-차이': '/간수치-종류-차이/',
    'diagnostics-lft-ast-우세-원인': '/간수치-AST-우세-원인/',
    'diagnostics-lft-높음': '/간수치-높음/',
    'diagnostics-lft-운동후-상승': '/간수치-운동후-상승/',
    'diagnostics-bilirubin-직접-간접': '/빌리루빈-직접-간접/',
    'diagnostics-albumin-pt-간합성능': '/알부민-PT-간합성능/',
    'diagnostics-biopsy-언제-필요한가': '/간생검-언제-필요한가/',
    'diagnostics-cirrhosis-정상수치-함정': '/간경변-정상수치-함정/',
    # MASLD / Alcohol
    'masld-alcohol-간질환': '/알코올성-간질환/',
    'masld-masld-치료': '/지방간-치료/',
    'masld-masld-위고비-마운자로': '/지방간-위고비-마운자로/',
    # Viral hepatitis
    'viral-hav': '/A형간염/',
    'viral-hbv-백신': '/B형간염-백신/',
    'viral-hbv-결혼-임신': '/B형간염-결혼-임신/',
    'viral-hbv-평생약': '/B형간염-평생약/',
    'viral-hbv-hbeag-양성-음성': '/B형간염-HBeAg-양성-음성/',
    'viral-hcv-진단': '/C형간염-진단/',
