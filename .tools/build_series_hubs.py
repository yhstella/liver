...
SERIES = {
    "간암": {
        ...
        "topics": [
            (1, "간암 진단을 받았을 때, 첫 외래에서 결정되는 것", "/간암-진단-첫외래/",
             "병기 평가, 추가 영상, 치료팀 구성 — 첫 만남에서 무엇이 결정되는지"),
            (2, "BCLC 병기와 치료 옵션 — 무엇이 어떤 환자에게", "/간암-BCLC병기/",
             "0·A·B·C·D 단계별 표준치료와 한국 임상에서의 적용"),
            (3, "절제술 vs 색전술 vs 방사선 — 선택의 기준", "/간암-치료-선택/",
             "종양 위치·간 기능·환자 상태가 만드는 선택의 분기점"),
            (4, "면역치료 1차 시대 — atezolizumab+bevacizumab과 그 이후", "/간암-면역치료-1차/",
             "IMbrave150 이후 1차 옵션의 변화, 적응증과 부작용"),
            (5, "간이식 — 적응증과 대기 기간", "/간암-간이식/",
            ...
            (9, "간암 재발 추적 — 첫 5년의 일정", "/간암-재발-추적/",
             "치료 후 영상·종양표지자 일정, 재발 패턴별 대응"),
            (10, "간암 환자가 알아야 할 식이·일상", "/간암-식이-일상/",
    ...
    "간경화": {
        ...
        "topics": [
            (1, "대상성 vs 비대상성 간경변 — 어디서 갈라지는가", "/간경변-대상성-비대상성/",
             "복수·정맥류 출혈·간성혼수·황달의 첫 등장이 만드는 단계 변화"),
            (2, "Child-Pugh와 MELD — 점수가 의미하는 것", "/간경변-Child-Pugh-MELD/",
             "두 점수의 사용 맥락 차이, 한계, 환자에게 설명하는 법"),
            (3, "식도정맥류 — 첫 신호와 예방적 결찰", "/간경변-식도정맥류/",
             "내시경 검진 주기, 1·2·3차 예방의 차이"),
            (4, "복수 — 단계별 관리", "/간경변-복수/",
             "식이·이뇨제·천자, SBP 예방, 난치성 복수의 옵션"),
            (5, "간성혼수 — 외래에서 알아채는 신호", "/간경변-간성혼수/",
             "수면 패턴 변화, 손떨림, 가족이 먼저 알아채는 변화"),
            (6, "간신증후군 — 진단과 즉각 대응", "/간경변-간신증후군/",
             "AKI 기준, 알부민+terlipressin/노르에피네프린, 간이식 brigade"),
            (7, "간경변 영양·근감소증(sarcopenia) 관리", "/간경변-영양-근감소증/",
             "단백질 섭취·야식·운동 — 흔한 오해와 실제 권고"),
            (8, "간이식 평가 — 누가, 언제 시작하나", "/간경변-간이식-평가/",
             "MELD 임계값, 동시 평가, KONOS 등록의 흐름"),
            (9, "간경변 환자가 피해야 할 약·영양제", "/간경변-약물-주의/",
             "NSAIDs, 일부 한약·건강기능식품, 진정제 — 외래에서 점검하는 목록"),
            (10, "간기능검사가 정상인데 간경변? — 진행된 간경변의 함정", "/간경변-정상수치-함정/",
    ...
    "B형간염": {
        ...
        "topics": [
            ...
            (5, "B형간염 백신 — 누가, 언제, 몇 번", "/B형간염-백신/",
             "성인·소아 일정, 무반응자 대응, 면역저하 상태에서의 boost"),
            (6, "HBeAg 양성 vs 음성 — 무엇이 다른가", "/B형간염-HBeAg-양성-음성/",
             "두 phase의 자연사 차이, 치료 적응증·기간의 차이"),
            (7, "항바이러스제 비교 — TDF · TAF · ETV", "/B형간염-항바이러스제-비교/",
             "신기능·골밀도 차이, 임신·수유, 약가, 전환의 기준"),
            (8, "B형간염 functional cure — 어디까지 와 있나", "/B형간염-functional-cure/",
             "siRNA·capsid inhibitor·면역조절제 임상의 현 위치"),
            (9, "항암치료·면역억제제와 B형간염 재활성화", "/B형간염-재활성화/",
    ...
    "지방간": {
        ...
        "topics": [
            ...
            (7, "lean MASLD — 마른 사람의 지방간", "/지방간-lean-MASLD/",
             "정상 BMI에서의 지방간, 동양인 cut-off, 위험 인자 점검"),
            (8, "resmetirom과 차세대 지방간 약물", "/지방간-신약-resmetirom/",
             "MAESTRO 시험 결과, 적응증, 한국 보험 현황"),
            (9, "지방간염(MASH) — 단순 지방간과 무엇이 다른가", "/지방간염-MASH/",
             "조직 변화, 진행 위험, 진단·치료의 분기점"),
            (10, "SGLT2·GLP-1 작용제와 지방간", "/지방간-SGLT2-GLP1/",
    ...
    "간수치": {
        ...
        "topics": [
            ...
            (3, "Fibroscan(간섬유화 스캔) 수치 읽는 법 — F0부터 F4까지", "/간섬유화스캔-수치/",
             "kPa 값 해석, CAP 지방량 수치"),
            (4, "빌리루빈 — 직접·간접 빌리루빈의 차이", "/빌리루빈-직접-간접/",
             "용혈성·간세포성·담도성을 가르는 패턴"),
            (5, "알부민·PT(INR) — 간의 합성능을 보는 방법", "/알부민-PT-간합성능/",
             "간 기능을 가장 직접적으로 보는 두 수치의 의미와 시간"),
            (6, "ALP·GGT — 담도 막힘 vs 간세포 손상", "/ALP-GGT-담도-간세포/",
             "두 수치의 조합으로 담도 vs 간세포를 어떻게 가르나"),
            (7, "약물·영양제·한약 — 간 손상 가능성 점검", "/약물성-간손상-DILI/",
             "외래에서 자주 만나는 간독성 원인, 사진으로 정리하는 법"),
            (8, "간수치가 정상인데도 간경변일 수 있다 — 진행된 간경변의 함정", "/간경변-정상수치-함정/",
             "혈액검사가 안심을 주지 못하는 상황과 영상 평가의 역할"),
            (9, "PIVKA-II — 간암 종양표지자의 또 다른 축", "/PIVKA-II-간암마커/",
             "AFP와의 보완 관계, 와파린 복용의 영향"),
            (10, "간생검 — 언제 필요한가", "/간생검-언제-필요한가/",
