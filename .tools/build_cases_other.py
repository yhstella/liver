...
CASES.append({
    ...
    "sections": [
        ...
        ("결정과 경과",
         "<p>BCLC A기 단일 1.6 cm HCC, Child-Pugh A로 다학제적 논의에서 <strong>고주파열치료술</strong>을 결정하였습니다. 시술은 합병증 없이 완전 괴사가 확인되었고, 1·3·6개월 영상에서 잔존 종양 없음, AFP·PIVKA-II 모두 정상화되었습니다. 향후 6개월마다 평생 추적 + 항바이러스제(TAF) 유지 계획입니다.</p>"),
    ],
    "teaching": [
