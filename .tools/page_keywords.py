...
PAGE_KEYWORDS: dict[str, list[str]] = {
    ...
    # === C형 간염 세부주제 (6-1, 6-3) — 6-2는 위 C형간염-완치-DAA ===
    "C형간염-진단": ["C형간염", "anti-HCV", "DAA", "Fibroscan", "검진"],
    "C형간염-완치후-추적": ["C형간염", "DAA", "검진", "간세포암", "간경변"],

    # === C형 간염 케이스 (6-4 ~ 6-5) ===
    "케이스/anti-HCV양성-첫발견": ["C형간염", "anti-HCV", "DAA", "Fibroscan", "검진"],
    "케이스/C형간염-간경변-새결절": ["C형간염", "간경변", "간세포암", "EOB-MRI", "검진"],

    # === 자가면역간염 세부주제 (7-1 ~ 7-3) ===
    "자가면역간염-진단": ["자가면역간염", "ANA", "ASMA", "IgG", "간생검"],
    "자가면역간염-치료": ["자가면역간염", "스테로이드", "아자티오프린", "ALT", "추적"],
    "자가면역간염-약중단": ["자가면역간염", "스테로이드", "아자티오프린", "재발", "추적"],

    # === 자가면역간염 케이스 (7-4 ~ 7-5) ===
    "케이스/AIH-첫진단-여성": ["자가면역간염", "스테로이드", "아자티오프린", "IgG", "ALT"],
    "케이스/AIH-약중단-재발": ["자가면역간염", "스테로이드", "아자티오프린", "재발", "추적"],
    ...
    # === 간 양성종양 (대주제 8) ===
    "간양성종양-진단": ["간양성종양", "혈관종", "간낭종", "FNH", "선종"],
    "간양성종양-낭종-관리": ["간낭종", "간양성종양", "경화요법", "블레오마이신", "추적"],
    "간양성종양-혈관종": ["혈관종", "간양성종양", "추적", "EOB-MRI", "검진"],
    "간양성종양-FNH-Adenoma": ["FNH", "선종", "간양성종양", "절제", "추적"],
    "케이스/큰낭종-bleomycin-경화요법": ["간낭종", "블레오마이신", "경화요법", "간양성종양", "추적"],
}
